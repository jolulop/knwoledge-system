...
**Status:** **Complete + pushed** — all slices **6-1 (read model), 6-2 (decisions), 6-3 (apply),
6-4 (HTML UI)** committed + pushed (design-locked 2026-06-19/22 via grill gate; A8 + this §5).
